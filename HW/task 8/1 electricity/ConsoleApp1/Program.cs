...
namespace ConsoleApp1
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            HouseReport report2 = new HouseReport();
            try
            {
                report2.ReadFromStreamReader(new StreamReader(@"D:\.NET course\Electricity accounting\ConsoleApp1\input2.txt"));
            }
            catch (Exception ex)
            {
                Console.WriteLine(  ex.Message);
            ...
            Console.WriteLine("combined reports:");
            Console.WriteLine(report + report2);
